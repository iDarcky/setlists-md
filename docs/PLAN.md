...
> | **Then** | **10 → 13** — getting to the next song, chord diagrams, the practice tools, and 13. All BUILT and shipping; none has had its element pass. ⚠ Element 12 carries a known correction: **the metronome must not start on tap** (item 1 below). |
