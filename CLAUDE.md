...
└── components/
    ...
    ├── SongHub.jsx           # Song-open target: media "hub card" (art · title + gold key · meta · ⋯ · Edit · Campfire) over a "reader card" whose tab header (Chart/Lyrics/Details, brand pills) carries the chart-only Aa + full-screen controls; backing-track player is a bottom card on desktop, inline in the media card on phones
