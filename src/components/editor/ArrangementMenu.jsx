  ...
  return (
    <div ref={rootRef} className="relative inline-block">
      <button
        type="button"
        onClick={() => setOpen(v => !v)}
        className="inline-flex items-center h-8 gap-1.5 px-2 rounded-md bg-transparent border-none text-label-12 font-semibold text-[var(--ds-gray-1000)] hover:bg-[var(--ds-gray-100)] cursor-pointer transition-colors max-w-[220px]"
        aria-haspopup="menu"
        aria-expanded={open}
