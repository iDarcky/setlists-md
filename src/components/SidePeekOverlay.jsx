    ...
    <div className="fixed inset-0 z-[120] flex justify-end">
      ...
      >
        <div className="h-14 flex items-center justify-between px-4 border-b border-[var(--ds-gray-200)] shrink-0 bg-[var(--ds-background-100)]">
          ...
          <button
            onClick={onOpenFull}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-transparent border-none text-label-13 font-medium text-[var(--ds-gray-600)] hover:text-[var(--ds-gray-900)] hover:bg-[var(--ds-gray-200)] transition-colors cursor-pointer"
          >
            Open as page
