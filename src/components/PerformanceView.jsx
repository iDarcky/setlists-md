...
export default function PerformanceView({ setlist, songs, onBack, onFinish, defaultFontSize, railEnabled = true, navStyle = 'pill', settings, onUpdateSettings, teamId = null, userId = null, onAppendSong }) {
  ...
  // uncluttered — leaving just the menu + the close X on the right.
...
function SongChart({ song, selectedKey, capo, fontSize, columns, chordFontSize, notation = 'letters', showChords = true, showDiagrams = false, displayMode = 'chords', tabInstrument = 'all', chordEmphasis = 'full', sectionColors, sectionLabels, customSectionTypes, privateNotes }) {
