...
export default function EdgeNavArrows({ onPrev, onNext, hasPrev, hasNext, onFinish, nextLabel, prevLabel }) {
  ...
  const edgeBtn = 'pointer-events-auto flex items-center justify-center w-12 h-16 text-[var(--ds-gray-900)] opacity-30 hover:opacity-100 active:opacity-100 transition-all duration-150 disabled:opacity-10 disabled:pointer-events-none';
  const peekChip = 'pointer-events-none absolute top-14 max-w-[55vw] truncate px-2.5 py-1 rounded-lg text-label-12 font-semibold bg-[var(--ds-gray-1000)] text-[var(--ds-background-100)] shadow-lg';
