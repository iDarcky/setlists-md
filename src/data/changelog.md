...
- **Repeat a section from the song map (Labs)** — while editing, every chip in the structure row gets a **+** that plays that section once more. The chip's ×2 becomes ×3, so you're editing the map in the map's own language instead of walking down the page moving headings.
