...
- **Edit the play order on the song map (Labs)** — while editing, a **+** at the end of the structure row lets you pick any section and add it, and you can **press and hold a chip to drag it** somewhere else in the order. Chips showing ×3 move all three together. The up/down arrows on the section headings are gone; the × to take a section out stays where you can see it.
