...
- **Fonts are a drop-down and colours are one line (Labs)** — the font pills were the widest thing on the tab and the palette reflowed into three rows; both are compact now.
- **Every group in the ☰ has a Reset (Labs)** — Theme, Lyrics, Chords, Spacing and Tabs each get their own, and it only appears when there's actually something to put back.
