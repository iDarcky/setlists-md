...
- **The ☰ sheet is smaller, and a fixed size (Labs)** — it takes up less of the screen, it's the same size on every tab so the song behind it never jumps, and the settings scroll inside it. Drag the handle down to put it away.
