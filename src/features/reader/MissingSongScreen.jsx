...
export default function MissingSongScreen({
  title, onExit, onMenu, aboveBar = null, leading = null, onRestore, onSkip, footer, hasNext = false,
}) {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden" style={chartSurface}>
      ...
      <ReaderTopBar title={title || 'Missing song'} onExit={onExit} onMenu={onMenu} aboveBar={aboveBar} leading={leading} />
